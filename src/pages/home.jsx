...
function Home() {
    ...
    return (
        ...
        <section className="hidden lg:block lg:w-3/4 relative overflow-hidden">
            <img src="/images/sari-sari-store (1).jpg" alt="Sari-sari store" className="h-full w-full" />
            <div className="absolute inset-0 bg-black/50 pointer-events-none"></div>
        </section>

        <section className="w-full flex justify-center items-center lg:w-1/3 p-10 lg:flex lg:justify-center lg:items-center h-screen">
